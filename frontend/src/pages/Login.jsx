...
import { BrainCircuit, AlertCircle, Key, Mail, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col justify-center py-12 sm:px-6 lg:px-8 animate-fade-in">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <p className="text-sm text-slate-500 mt-2">Sign in to your account to resume learning</p>
      </div>
